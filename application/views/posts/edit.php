<?php require APPPATH . 'views/inc/header.php'; ?>
  <a href="<?php echo site_url(); ?>posts" class="btn btn-light"><i class="fa fa-backward"></i> Back</a>
  <div class="card card-body bg-light mt-5">
    <h2>Edit Post</h2>
    <p>Create a post with this form</p>
    <form action="<?php echo site_url(); ?>posts/edit/<?php echo $post['id']; ?>" method="post">
